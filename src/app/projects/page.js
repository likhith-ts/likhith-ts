    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project) => (
          <div key={project.id} className="bg-gray-100 dark:bg-gray-800 shadow-md rounded-lg p-6">
            ...
            <div className="flex space-x-4">
              <Link
                ...
                className="bg-gray-800 dark:bg-gray-200 text-white dark:text-gray-800 px-4 py-2 rounded hover:bg-gray-700 dark:hover:bg-gray-300"
              >
                GitHub
              </Link>
              {project.liveUrl && (
