...
export default function Home() {
  return (
    <div className="flex flex-col items-center">
      <h1 className="text-4xl font-bold mb-6">Welcome to My ML Developer Portfolio</h1>
      <Image
      ...
      <p className="text-xl mb-8 text-center max-w-2xl">
        Hi, I'm [Your Name]. I'm a machine learning developer passionate about creating intelligent systems and solving
